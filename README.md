# LLM Sentinel Navigation Agent: `Reasoner` & `SentinelMeetingAgent`
...
&nbsp;&nbsp;&nbsp;&nbsp;a. Action planning  
&nbsp;&nbsp;&nbsp;&nbsp;b. Scene-graph reconstruction from language  
&nbsp;&nbsp;&nbsp;&nbsp;c. Safe-path proposal & route refinement (vision + text)  
